...
public class Chart1Panel extends JPanel {
    int num1; // O형의 수
    int num2; // A형의 수
    int num3; // B형의 수
    int num4; // AB형의 수
...
//    }
    ...
    Chart1Panel drawingPanel;

    // 생성자
//    public DrawingPieActionListener(JTextField text1, JTextField text2, JTextField text3, JTextField text4,Chart1Panel drawingPanel) {
//        this.text1 = text1;
//        this.text2 = text2;
//        this.text3 = text3;
//        this.text4 = text4;
